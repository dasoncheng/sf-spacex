...
export class LicensesController {
  ...
  @Post()
  async create(@Body() createLicenseDto: CreateLicenseDto): Promise<LicenseResponseDto> {
    return this.licensesService.create(createLicenseDto);
  }

  @Post('batch')
  async batchCreate(@Body() batchCreateDto: BatchCreateLicenseDto): Promise<LicenseResponseDto[]> {
